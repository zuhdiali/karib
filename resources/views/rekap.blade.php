              ...
              <div class="card-body">
                <ul class="nav nav-pills nav-secondary nav-pills-no-bd" id="pills-tab-without-border" role="tablist">
                  <li class="nav-item opsi-mingguan-klik">
                    <a class="nav-link active" id="opsi-mingguan" data-bs-toggle="pill" href="#pills-home-nobd" role="tab" aria-controls="pills-home-nobd" aria-selected="true">Mingguan</a>
                  </li>
                  <li class="nav-item opsi-bulanan-klik">
                    <a class="nav-link" id="opsi-bulanan" data-bs-toggle="pill" href="#pills-profile-nobd" role="tab" aria-controls="pills-profile-nobd" aria-selected="false">Bulanan</a>
                  </li>
                  <li class="nav-item opsi-triwulanan-klik">
                    <a class="nav-link" id="opsi-triwulanan" data-bs-toggle="pill" href="#pills-contact-nobd" role="tab" aria-controls="pills-contact-nobd" aria-selected="false">Triwulanan</a>
                  </li>
                </ul>
                <div class="tab-content mt-2 mb-3" id="pills-without-border-tabContent">
                  <div class="tab-pane fade show active" id="pills-home-nobd" role="tabpanel" aria-labelledby="opsi-mingguan">
                  ...
                  <div class="tab-pane fade" id="pills-contact-nobd" role="tabpanel" aria-labelledby="opsi-triwulanan">
                    <div class="form-group">
