...
<div class="container">
    <div class="page-inner">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form action="{{url('onar/update', $onar->id)}}" method="POST">
                        @csrf <!-- {{ csrf_field() }} -->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group {{$errors->has('nama') ? 'has-error has-feedback' : ''}}">
                                        ...
                                        <input
                                          ...
                                          value="{{ old('nama') ? old('nama') : $onar->nama }}"
                                        />
                                        @if ($errors->has('nama'))
                                    ...
                                    <div class="form-group {{$errors->has("tgl_penilaian") ? 'has-error has-feedback' : ''}}">
                                        ...
                                        <input
                                            ...
                                            id="tgl_penilaian"
                                            name="tgl_penilaian"
                                            value="{{ old("tgl_penilaian") ? old("tgl_penilaian") : $onar->tgl_penilaian }}"
                                        />
                                    ...
                                    <div class="form-group {{$errors->has('tahun') ? 'has-error has-feedback' : ''}}">
                                        ...
                                        <input
                                          ...
                                          value="{{ old('tahun') ? old('tahun') : $onar->tahun }}"
                                        />
                                        @if ($errors->has('tahun'))
                                    ...
                                    <div class="form-group {{$errors->has("triwulan") ? 'has-error has-feedback' : ''}}">
                                        ...
                                        >
                                            ...
                                            <option value="1" {{ $onar->triwulan == 1 ? 'selected' : '' }}>Triwulan I</option>
                                            <option value="2" {{ $onar->triwulan == 2 ? 'selected' : '' }}>Triwulan II</option>
                                            <option value="3" {{ $onar->triwulan == 3 ? 'selected' : '' }}>Triwulan III</option>
                                            <option value="4" {{ $onar->triwulan == 4 ? 'selected' : '' }}>Triwulan IV</option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="{{$errors->has('nominasiOnar[]') ? 'has-error has-feedback' : ''}}">
                                        <label for="nominasiOnar[]">Pegawai Yang Menjadi Nominasi</label>
                                        <select class="form-select" id="nominasiOnar" name="nominasiOnar[]" multiple="multiple">
                                            @foreach ($outsourcings as $item)
                                            <option value="{{$item->id}}" {{ in_array($item->id, $nominasiOnars) ? 'selected' : '' }}>
                                                {{$item->nama}}
                                            </option>
                                            @endforeach
                                        </select>
                        ...
                        <div class="card-action">
                            <button type="submit" class="btn btn-success">Edit ONAR</button>
                        </div>
                    </form>
                </div>
            </div>
